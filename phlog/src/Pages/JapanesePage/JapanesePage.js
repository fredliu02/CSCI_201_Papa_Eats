...
function JapanesePage() {
    ...
    const apiGet = () => {
        fetch("https://future-badge-366719.uw.r.appspot.com/api/restaurants/cuisine/Japanese")
        ...
        <Box sx={{ flexGrow: 1, marginTop: "2%"}}>
            <Grid container>
                <Grid item xs={12} style={{ textAlign: "center" }}>
                    <h1> Welcome to the Japanese Cuisine Page! </h1>
                    <h4> Click to display restaurants below: </h4>
                    <Button onClick={apiGet} variant="contained">
                        Load Japanese Restaurants
                    </Button>
                </Grid>
                <Grid item xs={12}>        
                        <ul>
